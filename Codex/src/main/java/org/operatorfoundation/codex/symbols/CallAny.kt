...
class CallAny(val value: Char) : Symbol {
    companion object : SymbolFactory<CallAny> {
    ...
    override fun toString(): String = "CallAny($value)"
    ...
    override fun decode(): BigInteger {
        ...
        throw IllegalArgumentException("CallAny, bad value: $value")
    }
}